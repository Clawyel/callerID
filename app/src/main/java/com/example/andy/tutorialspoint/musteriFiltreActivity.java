...
public class musteriFiltreActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.musteri_filtre_activity);
        ...
        final String anahtar = extras.getString("anahtar");
        ...
        new mfaAdapterForCard(this).execute("http://iskenderunveterinerklinigi.com/api/musteriler/search.php?s="+anahtar);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.aramalar) {
            ...
            Intent i = new Intent(musteriFiltreActivity.this, MainActivity.class);
            startActivity(i);
        } else if (id == R.id.aracGonderimleri) {
            Intent i = new Intent(musteriFiltreActivity.this, aracGonderimleriListesi.class);
            startActivity(i);
        } else if (id == R.id.musteriler) {
            Intent i = new Intent(musteriFiltreActivity.this, musteriler.class);
            startActivity(i);
        }  else if (id == R.id.soforler) {
            Intent i = new Intent(musteriFiltreActivity.this, soforlerActivity.class);
            startActivity(i);
        } else if (id == R.id.araclar) {
            Intent i = new Intent(musteriFiltreActivity.this, araclarActivity.class);
            startActivity(i);
        }
