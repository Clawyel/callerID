...
public class araclarAdapterForCard
        extends AsyncTask<String, String, String> {
    public List<String> str;
    private araclarActivity araclarActivity;
    public ArrayList<HashMap<String, String>> contactList;
    public String tmp;
    public araclarAdapterForCard(araclarActivity a)
    {
        this.araclarActivity = a;
    }
    ...
    protected void onPostExecute(String s) {
        ...
        try
        {
            ...
            this.araclarActivity.setListAraclar(contactList);
