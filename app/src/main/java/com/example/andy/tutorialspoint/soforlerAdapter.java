...
public class soforlerAdapter extends AsyncTask<String, String, String> {
    public List<String> str;
    private aracGonderimleri aracGonderimleri;
    public ArrayList<HashMap<String, String>> contactList;
    public String tmp;
    public soforlerAdapter(aracGonderimleri a)
    {
    ...
    protected void onPostExecute(String s) {
        ...
        try
        {
            ...
            this.aracGonderimleri.setListSoforler(contactList);
